...
IdWaves::FormCortex1::FormCortex1(void)
{
	this->InitializeComponent();
}


IdWaves::FormCortex1::~FormCortex1()
{
	if (components)
	{
		delete components;
...
void IdWaves::FormCortex1::InitializeComponent(void)
{
	...
	this->Button1->Click += gcnew System::EventHandler(this, &FormCortex1::Button1_Click);
	// 
	// Button11
	// 
	...
	this->Button11->Click += gcnew System::EventHandler(this, &FormCortex1::Button11_Click);
	// 
	// Button5
	// 
	...
	this->Button5->Click += gcnew System::EventHandler(this, &FormCortex1::Button5_Click);
	// 
	// Label1
	// 
	...
	this->Button3->Click += gcnew System::EventHandler(this, &FormCortex1::Button3_Click);
	// 
	// CheckedListBox1
	// 
	...
	this->CheckedListBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &FormCortex1::CheckedListBox1_SelectedIndexChanged);
	this->CheckedListBox1->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &FormCortex1::CheckedListBox1_MouseUp);
	// 
	// Button6
	// 
	...
	this->Button6->Click += gcnew System::EventHandler(this, &FormCortex1::Button6_Click);
	// 
	// Label3
	// 
	...
	this->Button2->Click += gcnew System::EventHandler(this, &FormCortex1::Button2_Click);
	// 
	// Button4
	// 
	...
	this->Button4->Click += gcnew System::EventHandler(this, &FormCortex1::Button4_Click);
	// 
	// ComboBox2
	// 
	...
	this->Name = L"FormCortex1";
	this->StartPosition = System::Windows::Forms::FormStartPosition::Manual;
	this->Text = L"Волновая активность";
	this->Load += gcnew System::EventHandler(this, &FormCortex1::FormCortex1_Load);
...
void IdWaves::FormCortex1::block() {
	this->Enabled = false;
...
void IdWaves::FormCortex1::unblock() {
	this->Enabled = true;
...
// Инициализация
void IdWaves::FormCortex1::FormCortex1_Load(Object ^sender, System::EventArgs ^e)
{
...
void IdWaves::FormCortex1::Button1_Click(Object ^sender, System::EventArgs ^e)
{
	...
	this->FormCortex1_Load(sender, e);
}

			
// Отображение картинки обучения
void IdWaves::FormCortex1::DrawLearningPicture() {
...
void IdWaves::FormCortex1::Tact() {
	...
	if (this->bcore->FPic == false && Label2->Text == "вкл.") {
		...
		System::Windows::Forms::MessageBox::Show("Серия картинок готова");
	}
...
void IdWaves::FormCortex1::Button3_Click(Object ^sender, System::EventArgs ^e)
{
	block();
	this->Tact();
	unblock();
...
// 50 тактов волны
void IdWaves::FormCortex1::Button11_Click(Object ^sender, System::EventArgs ^e)
{
	int NT = 50;
	block();
	for (int n = 0; n < NT; n++)
...
// 200 тактов волны
void IdWaves::FormCortex1::Button5_Click(Object ^sender, System::EventArgs ^e)
{
	int NT = 200;
	block();
	for (int n = 0; n < NT; n++)
...
// вкл. серии картинок
void IdWaves::FormCortex1::Button2_Click(Object ^sender, System::EventArgs ^e)
{
...
void IdWaves::FormCortex1::DrawSomeActivity() {
...
void IdWaves::FormCortex1::Button4_Click(Object ^sender, System::EventArgs ^e)
{
	if (Button4->Text == "Создать туннель") {
		...
		formcortex2 = gcnew IdWaves::FormCortex2();
		formcortex2->PictureBox1->Image = this->bcore->cortex2->pic;
		formcortex2->PictureBox1->Update();
					
		// Показ второго слоя
		System::Drawing::Point ^point = gcnew System::Drawing::Point(System::Windows::Forms::Screen::PrimaryScreen->Bounds.Width - formcortex2->Size.Width, System::Windows::Forms::Screen::PrimaryScreen->Bounds.Height - formcortex2->Size.Height);
...
void IdWaves::FormCortex1::Button6_Click(Object ^sender, System::EventArgs ^e)
{
...
void IdWaves::FormCortex1::CheckedListBox1_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e) {
	this->bcore->CheckedPatterns->Clear();
	for (int i = 0; i < CheckedListBox1->CheckedItems->Count; i++) {
		this->bcore->CheckedPatterns->Add(System::Convert::ToInt32(CheckedListBox1->CheckedItems[i]->ToString()));
	}
}

			
// Срабатывает при отпускании кнопки мыши
void IdWaves::FormCortex1::CheckedListBox1_MouseUp(Object ^sender, System::Windows::Forms::MouseEventArgs ^e)
{
